...
<div class="container">
    ...
    <div class="main">
        <div class="tittle">
            <h1>Add Clerk for Zonal Education Office</h1>
        </div>
                ...
                <div class="main-editprofile-block">
                    ...
                    <div class="main-editprofile-right">
                        <select id="designation" name="designation">
                            <option value="Salary Clerk">Clerk of the Salary Dept.</option>
                            <option value="Transfer Clerk">Clerk of the Trasfer Dept.</option>
                        </select>
                    </div>
                    <span class="error"><?php echo $data['confirm_password_err'] ?></span>
                </div>
