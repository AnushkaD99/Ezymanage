...
<div class="container">
    ...
    <div class="main">
                ...
                <div class="upperbar-right">
                    <div class="filter">
                        ...
                        <select name="Grade" id="filter3">
                            ...
                            <option value="SLPS 1">First Class</option>
                            <option value="SLPS 2">Second Class First Grade</option>
                            <option value="SLPS 3">Second Class Second Grade</option>
                        </select>
                    </div>
        ...
        <div class="second-row">
            <div><h3>All Principals : <span><?php echo $data['principal_count']->count; ?></span></h3></div>
            <button class="print-button" onclick="printDiv('report')"><i class="fas fa-print"></i> Print</button>
        </div>
        <div id="report">
            <div class="hidden">Principal details</div>
            <table id="table-customize">
                ...
                <?php foreach ($data['principal'] as $principal) : ?>
                    <tr class="employee-row">
                        ...
                        <td><?php echo $principal->nic; ?></td>
                        <td class="emp-gender"><?php echo $principal->gender; ?></td>
                        <td><?php echo $principal->birthday; ?></td>
                        <td><?php echo $principal->email; ?></td>
                        <td><?php echo $principal->contact_num; ?></td>
                        <td><?php echo $principal->address; ?></td>
                        <td class="emp-school"><?php echo $principal->school; ?></td>
                        <td class="emp-grade"><?php echo $principal->grade; ?></td>
                    </tr>
                <?php endforeach; ?>
            </table>
        </div>
