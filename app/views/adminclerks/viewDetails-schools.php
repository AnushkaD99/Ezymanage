    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="main-viewDetails-buttons">
                ...
                <a href="<?php echo URLROOT; ?>/adminclerks/viewDetails_schools"><div class="main-viewDetails-buttons-5 select-btn active">Schools</div></a>
            </div>
            <div class="content">
                <div id="schools">
                    <table id="table-customize">
                        ...
                        <div class="search-bar">
                            ...
                            <div class="add">
                                <a href="<?php echo URLROOT; ?>/adminclerks/add_school"><div class="btn3"><i class="fa-solid fa-plus"></i> Add School</div></a>
                            </div>
                        </div>
                        <br>
                        <tr>
