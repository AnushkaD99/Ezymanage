            ...
            <div id="schools">
                <table id="table-customize">
                    ...
                    <div class="search-bar">
                        ...
                        <!-- <div class="add">
                                <a href="<?php echo URLROOT; ?>/directors/add_director"><div class="btn3"><i class="fa-solid fa-plus"></i> Add Director</div></a>
                            </div> -->
                    </div>
                    <br>
                    <tr>
                    ...
                    <?php foreach ($data['directors'] as $directors) : ?>
                        <tr>
                            ...
                            <td id="center"> <a href="<?php echo URLROOT; ?>/directors/viewMoreDirectorDetails/<?php echo $directors->emp_no; ?>" class="btn3">More</a></td>
                        </tr>
                    <?php endforeach; ?>
                </table>
            </div>
