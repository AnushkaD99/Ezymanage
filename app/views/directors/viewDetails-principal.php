            ...
            <div id="principals">
                <table id="table-customize">
                    ...
                    <div class="search-bar">
                        ...
                        <!-- <div class="add">
                            <a href="<?php echo URLROOT; ?>/directors/add_principal">
                    ...
                    <?php foreach ($data['principals'] as $principal) : ?>
                        <tr>
                            ...
                            <td id="center"> <a href="<?php echo URLROOT; ?>/directors/viewMorePrincipalDetails/<?php echo $principal->emp_no; ?>" class="btn3">More</a></td>
                        </tr>
                    <?php endforeach; ?>
                </table>
            </div>
