                ...
                <table id="table-customize">
                    ...
                    <div class="search-bar">
                        <div class="form">
                            <form action="" method="POST">
                                <input type="text" placeholder="Search by school registration number or school name" class="search-tab" name="search" id="search-input"><!-- gap 
                                    --><button type="submit" class="search-btn"><i class="fa-solid fa-search"></i>Search</button>
                            </form>
                        </div>
                        <!-- <div class="add">
                                <a href="<?php echo URLROOT; ?>/directors/add_school"><div class="btn3"><i class="fa-solid fa-plus"></i> Add School</div></a>
                            </div> -->
                    </div>
                    <br>
                    <tr>
                    ...
                    <?php foreach ($data['schools'] as $school) : ?>
                        <tr>
                            ...
                            <td id="center"> <a href="<?php echo URLROOT; ?>/directors/viewMoreSchoolDetails/<?php echo $school->school_id; ?>" class="btn3">More</a></td>
                        </tr>
                    <?php endforeach; ?>
                </table>
            </div>
