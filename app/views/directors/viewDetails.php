    ...
    <div class="main">
        ...
        <div class="main-viewDetails-buttons">
            <a href="<?php echo URLROOT; ?>/directors/viewDetails">
                <div class="main-viewDetails-buttons-1 select-btn active" id="select-btn1">Teachers</div>
            </a>
                ...
                <table id="table-customize">
                    ...
                    <div class="search-bar">
                        <div class="form">
                            <form action="" method="POST">
                                <input type="text" placeholder="Search by Employee number or name" class="search-tab" name="search" id="search-input><!-- gap 
                                    --><button type="submit" class="search-btn"><i class="fa-solid fa-search"></i>Search</button>
                            </form>
                        </div>
                        <!-- <div class="add">
                                <a href="<?php echo URLROOT; ?>/directors/add_teacher"><div class="btn3"><i class="fa-solid fa-plus"></i> Add Teacher</div></a>
                            </div> -->
                    </div>
                    <br>
                    <tr>
                    ...
                    <?php foreach ($data['teachers'] as $teacher) : ?>
                        <tr>
                            ...
                            <td id="center"> <a href="<?php echo URLROOT; ?>/directors/viewMoreTeacherDetails/<?php echo $teacher->emp_no; ?>" class="btn3">More</a></td>
                        </tr>
                    <?php endforeach; ?>
                </table>
            </div>
