        ...
        <h2 id="center">Payroll System</h1>
            ...
            <div class="content">
                <table id="table-customize">
                    ...
                    ?>
                        <tr>
                            <td> <input type="checkbox" name="chkId[]" value="<?php echo $payslip->emp_no; ?>" /> </td>
                            ...
                            <td><?php echo $payslip->allowances; ?></td>
                            <td><?php echo $payslip->deductions; ?></td>
                            <td><?php echo $payslip->net_salary; ?></td>
                            <td><?php echo $date; ?></td>
                            <td><center><div class="<?php echo $class; ?>"><?php echo $status; ?></div></center></td>
                            <td>
                                <button class="btn btn-primary edit_payslip" data-url="<?php echo URLROOT; ?>/salaryclerks/edit_payslip/<?php echo $payslip->emp_no; ?>" type="button"><i class="fa-solid fa-pen-to-square" style="color: #FFA500;"></i></button>
                                ...
                                <a href="<?php echo URLROOT; ?>/salaryclerks/send_payslip/<?php echo $payslip->emp_no; ?>"><button><i class="fa-solid fa-paper-plane" style="color: #0000FF;"></i></button></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </table>
