...
<div class="container">
    ...
    <div class="sidebar">
        <ul>
            ...
            <li>
                <a href="<?php echo URLROOT; ?>/schoolclerks/school_profile" class="active"><i class="fa-solid fa-chalkboard-user"></i><span class="link">School Profile</span></a>
            </li>
            <li>
            ...
            <div class="main-col-2-left">
                <div class="border-box">
                    ...
                    <div class="input-field">
                        <label>Name:</label>                                    
                        <input type="text" name="name" value="<?php echo $data['schools']->name; ?>" disabled>
                                   
                    </div>
                    <div class="input-field">
                        <label>Name:</label>                                    
                        <input type="text" name="name" value="<?php echo $data['schools']->address; ?>" disabled>
                                   
                    </div>
                    <div class="input-field">
                        <label>Name:</label>                                    
                        <input type="text" name="name" value="<?php echo $data['schools']->contact_num; ?>" disabled>
                                   
                    </div>
                    <div class="input-field">
                        <label>Name:</label>                                    
                        <input type="text" name="name" value="<?php echo $data['schools']->principal; ?>" disabled>                                   
                    </div>
