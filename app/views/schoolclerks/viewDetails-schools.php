            ...
            <div id="schools">
                <table id="table-customize">
                    ...
                    <div class="search-bar">
                        ...
                        <!-- <div class="add">
                                <a href="<?php echo URLROOT; ?>/schoolclerks/add_school"><div class="btn3"><i class="fa-solid fa-plus"></i> Add School</div></a>
                            </div> -->
                    </div>
                    <br>
                    <tr>
                    ...
                    <?php foreach ($data['schools'] as $school) : ?>
                        <tr>
                            ...
                            <td id="center"> <a href="<?php echo URLROOT; ?>/schoolclerks/viewMoreSchoolDetails/<?php echo $school->school_id; ?>" class="btn3">More</a></td>
                        </tr>
                    <?php endforeach; ?>
                </table>
            </div>
