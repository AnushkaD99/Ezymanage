            ...
            <div id="teachers">
                <table id="table-customize">
                    ...
                    <div class="search-bar">
                        ...
                        <!-- <div class="add">
                                <a href="<?php echo URLROOT; ?>/schoolclerks/add_teacher"><div class="btn3"><i class="fa-solid fa-plus"></i> Add Teacher</div></a>
                            </div> -->
                    </div>
                    <br>
                    <tr>
                    ...
                    <?php foreach ($data['teachers'] as $teacher) : ?>
                        <tr>
                            ...
                            <td id="center"> <a href="<?php echo URLROOT; ?>/schoolclerks/viewMoreTeacherDetails/<?php echo $teacher->emp_no; ?>" class="btn3">More</a></td>
                        </tr>
                    <?php endforeach; ?>
                </table>
            </div>
