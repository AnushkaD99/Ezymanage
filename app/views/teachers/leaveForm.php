            ...
            <div class="main-2col-left">
                ...
                <form action="" method="POST" id="myForm">
                    <div class="content">
                        ...
                        <input class="submit-btn" type="submit" id="showToastBtn">
                    </div>
                </form>
            </div>
                    ...
                    <table class="row-space">
                        ...
                        <?php foreach ($data['leave_details'] as $leave_details) : ?>
                            <tr>
                                ...
                                <td class="align-right"><a href="<?php echo URLROOT; ?>/teachers/LeaveView/<?php echo $leave_details->leave_id; ?>" class="view-btn">More</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </table>
