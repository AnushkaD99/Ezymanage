    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="main-viewDetails-buttons">
                ...
                <a href="<?php echo URLROOT; ?>/adminclerks/viewDetails_directors"><div class="main-viewDetails-buttons-3 select-btn active" id="select-btn3">Directors</div></a>
                ...
                <div id="schools">
                    <table id="table-customize">
                        ...
                        <div class="search-bar">
                            ...
                            <div class="add">
                                <a href="<?php echo URLROOT; ?>/adminclerks/add_director"><div class="btn3"><i class="fa-solid fa-plus"></i> Add Director</div></a>
                            </div>
                        </div>
                        <br>
                        <tr>
