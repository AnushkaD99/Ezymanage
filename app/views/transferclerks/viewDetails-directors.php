    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="main-viewDetails-buttons">
                ...
                <a href="<?php echo URLROOT; ?>/transferClerks/viewDetails_directors"><div class="main-viewDetails-buttons-3 select-btn active" id="select-btn3">Directors</div></a>
                ...
                <a href="<?php echo URLROOT; ?>/transferClerks/viewDetails_schools"><div class="main-viewDetails-buttons-5 select-btn">Schools</div></a>
            </div>
            <div class="content">
                <div id="schools">
                    <table id="table-customize">
                        ...
                        <div class="search-bar">
                            ...
                            <!-- <div class="add">
                                <a href="<?php echo URLROOT; ?>/transferClerks/add_director"><div class="btn3"><i class="fa-solid fa-plus"></i> Add Director</div></a>
                            </div> -->
                        </div>
                        <br>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td id="center"> <a href="<?php echo URLROOT; ?>/transferClerks/viewMoreDirectorDetails/<?php echo $directors->emp_no; ?>" class="btn3">More</a></td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
                </div>
